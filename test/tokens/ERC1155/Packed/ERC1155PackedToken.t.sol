...
import {ERC1155PackedToken, InvalidInitialization} from "src/tokens/ERC1155/Packed/ERC1155PackedToken.sol";
import {ERC1155PackedTokenFactory} from "src/tokens/ERC1155/Packed/ERC1155PackedTokenFactory.sol";
...
contract ERC1155TokenTest is Test {
    ...
    ERC1155PackedToken private token;
    ...
    function setUp() public {
        ...
        ERC1155PackedTokenFactory factory = new ERC1155PackedTokenFactory();
        token = ERC1155PackedToken(factory.deploy(owner, "name", "baseURI", 0x0));
    }
    ...
    function testMintOwner(uint256 tokenId, uint256 amount) public {
        vm.assume(amount > 0 && amount < 2 ** 16);
    ...
    function testBatchMintOwner(uint256[] memory tokenIds, uint256[] memory amounts) public {
        ...
        for (uint256 i; i < amounts.length; i++) {
            amounts[i] = _bound(amounts[i], 1, 2 ** 16);
        }
